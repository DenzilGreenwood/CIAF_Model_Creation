...
\textbf{Proof Path for E4:} To verify evidence item E4 without materializing the full tree, the verifier needs only: Hash(E3), H1, and H2. The verification algorithm recomputes H4 = Hash(E3 || E4), then H1' = Hash(H3 || H4), then Root' = Hash(H1' || H2), confirming Root' = Root.
