...
try:
    from ciaf.compliance.citation_anchor import (
        CitationAnchor,
        CitationMetadata,
        UsageRecord,
        CitationType,
    ...
    print("✅ Using CIAF Citation Anchor module")
except ImportError as e:
    print(f"⚠️  CIAF module not available: {e}")
...
def demonstrate_citation_anchor():
    ...
    print("🔗 CIAF Citation Anchor System Demo")
    print("=" * 50)
