"""
Comprehensive Test Suite for DefenseAIGovernanceFramework

Tests cover all methods and compliance requirements across defense AI systems.
"""
...
class TestDefenseAIGovernanceFramework(BaseFrameworkTest):
    """Comprehensive test suite for DefenseAIGovernanceFramework"""

    def get_framework_class(self):
        """Return defense framework class"""
        return DefenseAIGovernanceFramework
    ...
    def get_regulatory_requirements(self) -> List[str]:
        """Return defense regulatory requirements"""
        return ['DOD_AI_PRINCIPLES', 'IHL_ARTICLE_36', 'NDAA_1051']

    def get_test_data(self) -> Dict[str, Any]:
        """Return defense-specific test data"""
        return {
    'defense_data': {
        'system_id': 'DEF123456',
    ...
    def test_framework_initialization_with_defaults(self):
        ...
        framework = DefenseAIGovernanceFramework(
    ...
    def test_multiple_instances_are_independent(self):
        ...
        framework1 = DefenseAIGovernanceFramework(organization_id='org_1')
        framework2 = DefenseAIGovernanceFramework(organization_id='org_2')
    ...
    def test_assessment_types(self, assessment_type):
        ...
        framework = DefenseAIGovernanceFramework(organization_id='test_org')
    ...
    def test_multiple_organizations(self, org_id):
        ...
        framework = DefenseAIGovernanceFramework(organization_id=org_id)
