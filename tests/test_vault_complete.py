...
NOTE: This test requires a live Vault server running on localhost:8002
Run with: pytest tests/test_vault_complete.py -m integration
"""
...
@pytest.mark.skipif(True, reason="Requires live Vault server on localhost:8002 - run manually with -m integration")
